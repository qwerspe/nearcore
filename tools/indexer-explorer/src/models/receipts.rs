...
impl Receipt {
    pub fn from_receipt(
        receipt_view: &near_indexer::Receipt
    ) -> Self {
        Self {
            ...
            status: match receipt_view.outcome.outcome.status {
...
impl ReceiptData {
    pub fn from_receipt(receipt_view: &near_indexer::Receipt) -> Result<Self, &str> {
